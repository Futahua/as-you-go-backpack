...
Shortcut descriptions are optional. Icons use the target's Windows icon by default or a
project-owned image chosen by the creator. External targets are never copied or changed.
