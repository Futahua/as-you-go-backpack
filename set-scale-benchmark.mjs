...
console.log('sets regime     entities possPr nearPr | comps maxComp maxEdge dens | maxPass compPass  pairVisits | certified | fbComps slots');
for (const row of rows) {
  ...
  console.log(
    ...
    '|',
    pad(d.certifiedInfeasibleComponents ?? 0, 9),
    '|',
